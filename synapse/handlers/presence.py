...
class PresenceHandler(object):
    ...
    def _update_states(self, new_states):
        ...
        with Measure(self.clock, "presence_update_states"):
            ...
            if to_federation_ping:
                ...
                _, _, hosts_and_states = yield self._get_interested_parties(
                    to_federation_ping.values()
                )

                self._push_to_remotes(hosts_and_states)
    ...
    def _get_interested_parties(self, states, calculate_remote_hosts=True):
        ...
        defer.returnValue((room_ids_to_states, users_to_states, hosts_and_states))
    ...
    def _persist_and_notify(self, states):
        ...
        room_ids_to_states, users_to_states, hosts_and_states = parties
    ...
    def _push_to_remotes(self, hosts_and_states):
        """Sends state updates to remote servers.

        Args:
            hosts_to_states (list): list of ([destinations], [states])
        """
        self.federation.send_presence(hosts_and_states)
    ...
    def user_joined_room(self, user, room_id):
        ...
        if self.is_mine(user):
            ...
            self._push_to_remotes([(hosts, [state])])
        else:
